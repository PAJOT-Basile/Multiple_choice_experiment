...
Get_Error_Rate_Per_SNP <- function(df){
  ...
  error_rate <- parallel::parSapply(cl = cl, X = list_positions, FUN = Get_Error_Rate_One_Position, df)
...
system2("/shared/software/miniconda/envs/vcftools-0.1.16/bin/vcftools",
        args = paste0(" --vcf /shared/projects/sexisol/finalresult/ddRAD_multiple_choice_exp/08_Calling/ddRAD_multiple_choice_experiment/populations.snps.vcf",
                      ...
                      " --recode > /shared/projects/sexisol/finalresult/ddRAD_multiple_choice_exp/09_thin_vcf/thinned_with_duplicated_positions.vcf"))
...
data <- read.vcfR("/shared/projects/sexisol/finalresult/ddRAD_multiple_choice_exp/09_thin_vcf/thinned_with_duplicated_positions.vcf") %>% 
  vcfR2genind()
...
system2("grep", args = paste0("-v -f /shared/projects/sexisol/finalresult/ddRAD_multiple_choice_exp/09_thin_vcf/unwanted_snps.txt",
                              " /shared/projects/sexisol/finalresult/ddRAD_multiple_choice_exp/09_thin_vcf/thinned_with_duplicated_positions.vcf",
                              " > /shared/projects/sexisol/finalresult/ddRAD_multiple_choice_exp/09_thin_vcf/thinned_1RAD.vcf"))
...
# Thinned vcf
data <- read.vcfR("/shared/projects/sexisol/finalresult/ddRAD_multiple_choice_exp/09_thin_vcf/thinned_1RAD.vcf",
                  verbose = FALSE) %>% 
  vcfR2genind()
...
########  Error rate  ########
##############################
# Get the error rate per snp using duplicates
...
system2("grep", args = paste0("-v -f /shared/projects/sexisol/finalresult/ddRAD_multiple_choice_exp/09_thin_vcf/Information_vcf/Positions_high_error.tsv",
                              " /shared/projects/sexisol/finalresult/ddRAD_multiple_choice_exp/09_thin_vcf/thinned_1RAD.vcf",
                              " > /shared/projects/sexisol/finalresult/ddRAD_multiple_choice_exp/09_thin_vcf/thinned_no_err.vcf"))


# Import data with no error
data_no_err <- read.vcfR("/shared/projects/sexisol/finalresult/ddRAD_multiple_choice_exp/09_thin_vcf/thinned_no_err.vcf",
                         verbose = FALSE) %>% 
  vcfR2genind()
...
system2("/shared/software/miniconda/envs/vcftools-0.1.16/bin/vcftools",
        args = paste0("--vcf /shared/projects/sexisol/finalresult/ddRAD_multiple_choice_exp/09_thin_vcf/thinned_no_err.vcf",
                      ...
                      " --recode --stdout",
                      " > /shared/projects/sexisol/finalresult/ddRAD_multiple_choice_exp/09_thin_vcf/VCF_File.vcf"))
...
##############################
system2("rm",
        args = paste0("/shared/projects/sexisol/finalresult/ddRAD_multiple_choice_exp/09_thin_vcf/thinned_*.vcf"))
